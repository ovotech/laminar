...
import { Kafka, ConsumerSubscribeTopic, ConsumerConfig, Consumer } from 'kafkajs';
import { SchemaRegistryConsumerRunConfig, DecodedKafkaMessage } from './types';

export class ConsumerService<TValue> implements Service {
  ...
  public describe(): string {
    return `Consumer ${this.config.topic}, group: ${this.config.groupId}`;
  }
}
