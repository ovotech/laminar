...
export async function start({ services, logger }: Context): Promise<void> {
...
export async function stop({ services, logger }: Context): Promise<void> {
...
export function stopOnSignal(signal: NodeJS.Signals, services: Context): void {
...
export async function run(context: Context, predicate: (context: Context) => Promise<void>): Promise<void> {
  await start(context);
  try {
...
export function testRun(context: Context, predicate: (context: Context) => Promise<void>): () => Promise<void> {
  return async () => {
    await run(context, predicate);
  };
}
